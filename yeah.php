...
<html>
    ...
    <body>
        <form action="php_insert_update_delete_search.php" method="post">
            ...
            <input type="text" name="fname" placeholder="Product Name" value="<?php echo $fname;?>"><br><br>
            <input type="text" name="lname" placeholder="Product price" value="<?php echo $lname;?>"><br><br>
            <input type="number" name="age" placeholder="product description" value="<?php echo $age;?>"><br><br>
            <div>
